...
// import games.planetwars.agents.ForwardThinker.RHEAAgent4
...
//    agents.add(AdvancedEvoAgent)
//    agents.add(RHEAAgent_v1_3())
//    agents.add(RHEAAgent4())

//    agents.add(RHEAAgent1())



    val remoteAgent = RemoteAgent("<specified by remote server>")
